            ...
            Column(
                ...
                IngredientGlassCard(
                    ...
                    when (order.paymentStatus) {
                        "pending" -> DetailField("Pago", "Pago pendiente", Color(0xFFFFC857))
                        ...
                        "failed" -> DetailField("Pago", "Pago fallido", MaterialTheme.colorScheme.error)
                        "cancelled" -> DetailField("Pago", "Pago cancelado", MaterialTheme.colorScheme.error)
                    }
